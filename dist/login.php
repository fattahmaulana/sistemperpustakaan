...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Pemeriksaan panjang kata sandi
    if (strlen($raw_password) < 8) {
        $pesan = "<div class='alert alert-danger'><strong>Error!</strong> Kata sandi harus memiliki setidaknya 8 karakter.</div>";
    } else {
        $password = input(md5($raw_password));

        //Query untuk cek pada tabel pengguna yang dioinjeksi dengan tabel karyawan
        ...
        //Query untuk cek pada tabel pengguna yang dioinjeksi dengan tabel anggota
